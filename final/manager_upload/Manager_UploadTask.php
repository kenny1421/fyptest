    ...
    <li>
      ...
      <li>
				<div class="iocn-link">
					...
					<ul class="sub-menu">
						<li><a class="link_name" href="Manager_UploadTask.php">Upload Task</a></li>
						<li><a href="../manager_viewtask/Manager_ViewTask.php">View Task</a></li>
					</ul>
				</li>
      <li>
                        ...
                        <?php
                           ...
                           foreach ($blobList->getBlobs() as $blob)
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href=" Manager_UploadTask.php?file_id=<?php echo
                                    $blob->getName()?>"<button class="btn btn-primary">Download</button></a>
                                
                                    <a href=" Manager_UploadTask.php?delete_id=<?php echo
