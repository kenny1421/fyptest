...
<div class="sidebar close">
    ...
    <ul class="nav-links">
    <li>
		<a href="Manager_Task.php">
			<i class='bx bx-task' ></i>
				<span class="link_name">Task</span>
					</a>
					<ul class="sub-menu blank">
						<li><a class="link_name" href="Manager_Task.php">Task</a></li>
					</ul>
	</li>
      <li>
  ...
  <section class="home-section">
    <div class="home-content">
      ...
      <span class="text">Annotation Tool</span>
    </div>
    <div class=home-body>
    ...
    <svg style="display:none;" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
      <defs>
        <symbol id="via_logo">
          ...
          <title>Image Annotator Logo</title>
        ...
        <ul>
          ...
          <li>Project
            <ul>
              ...
              <li onclick="project_file_add_url_with_input()" title="Add images from a web URL">Add files from URL</li>
    ...
    <div class="middle_panel">
      ...
      <div id="display_area">
        ...
        <div id="page_start_info" class="display_area_content display_none narrow_page_content">
          <ul>
            <li>To start annotation, <span class="text_button" title="Load or Add Images" onclick="sel_local_images()">select images</span> (or, add images from <span class="text_button" onclick="project_file_add_url_with_input()">URL</span> or <span class="text_button" title="Add images using absolute path of file (e.g. /home/abhishek/image1.jpg)" onclick="project_file_add_abs_path_with_input()">absolute path</span>) and draw regions</li>
        ...
        <div id="page_getting_started" class="display_area_content display_none narrow_page_content">
          ...
          <ol>
            <li><strong>Load Images</strong>: The first step is to load all the images that you wish to annotate. There are multiple ways to add images to a project. Choose the method that suits your use case.
              <ul>
                ...
                <li>Method 2: Adding files from URL or absolute path
                  <ol>
                    <li>Click <span class="text_button" title="Add Image" onclick="project_file_add_url_with_input()"><code>Project &rarr; Add files from URL</code></span></li>
...
function project_file_add_url_with_input() {
  ...
  var input = { 'url': { type:'text', name:'add one URL', placeholder:'Images/ann1.jpg', disabled:false, size:50 },
		'url_list': { type:'textarea', name:'or, add multiple URL (one url per line)', placeholder:'Images/ann2.jpg', disabled:false, rows:5, cols:80 }
              };
