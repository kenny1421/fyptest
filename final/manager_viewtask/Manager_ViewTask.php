...
<div class="sidebar close">
    ...
    <li>
      ...
      <li>
				<div class="iocn-link">
					<a href="../manager_upload/Manager_UploadTask.php">
					...
					<ul class="sub-menu">
						<li><a class="link_name" href="../manager_upload/Manager_UploadTask.php">Upload Task</a></li>
						<li><a href="Manager_ViewTask.php">View Task</a></li>
					</ul>
				</li>
      <li>
                        ...
                        <?php
                           ...
                           foreach ($blobList->getBlobs() as $blob)
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href=" User_ViewTask.php?delete_id=<?php echo
